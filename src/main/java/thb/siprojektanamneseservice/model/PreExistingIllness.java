...
public enum PreExistingIllness {
    ...
    private final String preExistingIllnes;

    PreExistingIllness(String preExistingIllnes) {
        this.preExistingIllnes = preExistingIllnes;
    }
}
